                ...
                <form action="#" className='w-full max-w-md flex flex-col space-y-7 bg-gradient-to-br from-white to-blue-50 border border-gray-200 rounded-xl p-8 shadow-xl transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl backdrop-blur-sm'>
                    ...
                    <div className='flex flex-col space-y-2'>
                        ...
                        <div className='relative'>
                            ...
                            <input type="text" id='username' placeholder='Your username' className='pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 w-full'/>
                        </div>
                    </div>
                    <div className='flex flex-col space-y-2'>
                    ...
                    <div className='flex flex-col space-y-2'>
                        ...
                        <input type="password" placeholder='Min 8 characters' id='password' className='pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 w-full'/>
                        </div>
                        <span className='text-sm text-gray-500'>Must be at least 8 characters long</span>
                    </div>
                    <div className='flex flex-col space-y-5'>
                        ...
                        <span className='text-center'>Already have an account? <Link href={'#'} className='text-blue-600 hover:text-blue-500 cursor-pointer' >Sign in</Link></span>
                    </div>
                </form>
    </section>
    </>
